...
public class Log {
    ...
    static public void severe (String message, Throwable ex) {
        if (ERROR) logger.log(LEVEL_ERROR, null, message, ex);
    }

    static public void severe (String category, String message, Throwable ex) {
    ...
    static public void severe () {
        if (ERROR) logger.log(LEVEL_ERROR, null, "", null);
    }

    static public void severe (String category, String message) {
    ...
    static public void warn () {
        if (WARN) logger.log(LEVEL_WARN, null, "", null);
    }
    ...
    static public void info () {
        if (INFO) logger.log(LEVEL_INFO, null, "", null);
    }
    ...
    static public void debug () {
        if (DEBUG) logger.log(LEVEL_DEBUG, null, "", null);
    }
    ...
    static public void trace () {
        if (TRACE) logger.log(LEVEL_TRACE, null, "", null);
    }
